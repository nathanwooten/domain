...
class FsFile
{
  ...
  public function __construct( $basename, $directory )
  {

    $this->basename = $basename;

    if ( ! $directory instanceof FsDirectory ) {
      $directory = new FsDirectory( $directory );
...
class ViewManager
{
  ...
  public function addTemplate( $source, $name, $properties = [] )
  {
    ...
    $directory = new ViewDirectory;

    $template = new View( $source, $name, $properties );
    return $template;
  ...
  public function prepare( ViewInterface $template = null )
  {

    $this->template = $template = $this->getTemplate( $template );
